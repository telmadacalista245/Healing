...
def cadastro_medico(request):
    ...
    if request.method == "GET":
        ...
        return render(request, 'cadastro_medico.html', {'especialidades': especialidades,'is_medico':is_medico})
...
def abrir_horario(request):
    ...
    if request.method == "GET":
       ...
       return render(request, 'abrir_horario.html', {'dados_medicos': dados_medicos, 'datas_abertas': datas_abertas,'is_medico':is_medico})
