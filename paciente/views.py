...
def home(request):
    if request.method == "GET":
        ...
        return render(request, 'home.html',{'medicos':medicos, 'especialidades':especialidades, 'is_medico':is_medico})
...
def escolher_horario(request, id_dados_medicos):
    if request.method == "GET":
        ...
        return render(request, 'escolher_horario.html', {'medico': medico, 'datas_abertas': datas_abertas,'is_medico':is_medico})
